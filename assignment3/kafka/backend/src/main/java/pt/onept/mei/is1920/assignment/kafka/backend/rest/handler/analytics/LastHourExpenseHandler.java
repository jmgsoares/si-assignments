...
public class LastHourExpenseHandler implements Route {
	private static Logger logger = LoggerFactory.getLogger(LastHourExpenseHandler.class);

	@Override
	public Object handle(Request request, Response response) {
		logger.info("Request to get Last Hour Expense");

		try {
			Connection conn = DBHandler.GetConnection();
			PreparedStatement ps = conn.prepareStatement("select value from \"Results\".\"TotalExpenseLastHour\"");
