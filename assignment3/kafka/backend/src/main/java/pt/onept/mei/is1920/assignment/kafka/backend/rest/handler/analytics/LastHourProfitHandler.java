...
public class LastHourProfitHandler implements Route {
	private static Logger logger = LoggerFactory.getLogger(LastHourProfitHandler.class);

	@Override
	public Object handle(Request request, Response response) {
		logger.info("Request to get Last Hour Profit");
