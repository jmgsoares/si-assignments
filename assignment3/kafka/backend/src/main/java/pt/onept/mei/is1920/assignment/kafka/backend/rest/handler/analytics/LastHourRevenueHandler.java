...
public class LastHourRevenueHandler implements Route {
	private static Logger logger = LoggerFactory.getLogger(LastHourRevenueHandler.class);

	@Override
	public Object handle(Request request, Response response) {
		logger.info("Request to get Last Hour Revenue");

		try {
			Connection conn = DBHandler.GetConnection();
			PreparedStatement ps = conn.prepareStatement("select value from \"Results\".\"TotalRevenueLastHour\"");
