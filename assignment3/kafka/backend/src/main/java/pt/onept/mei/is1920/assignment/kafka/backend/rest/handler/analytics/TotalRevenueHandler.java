...
public class TotalRevenueHandler implements Route {
	private static Logger logger = LoggerFactory.getLogger(TotalRevenueHandler.class);

	@Override
	public Object handle(Request request, Response response) {
		logger.info("Request to get Total revenue");

		try {
			Connection conn = DBHandler.GetConnection();
			PreparedStatement ps = conn.prepareStatement("select value from \"Results\".\"TotalRevenue\"");
